...
MSweep.Value = (float64)sweep / (float64)10e = (float64)sweep / (float64)10ep.Value;
...
dev1.md100se.MEbN01 = ((unsigned)(MEbN0100se.MEbN01 = ((unsigned)(MEbN0
...
extern "C" void SetMEthSend(unsigned long lows) //, unsigned long highs)
{
 // ethsend += (double)lows;//  + ((double)highs *(2 ^ 32));
  ...
  dev1.md100se.MEthSend3 > 16;
  dev1.md100se.MEthSend3 e.MEthSendH0 = highs;
...
ratimestep.ChangingValue = MIN_ratimestep;
 ...
 for(i = 0; i < USED_MODES; i++)
 {
   ...
   numode[10].Value =  11;	  numodenumode[10].Value =  11;	  numodeValue;
