...
//#include "pvg810\PVG810_privateStructs.h"

extern PVG810_DATABASE_STRUCT gPvg810Database[PVG810_NUM_OF_SYSTEMS];
#define  PVG810_DATABASE_STRUCT_LEN	 sizeof(gPvg810Database[0])
...
//#include "pvg810\PVG810_Application.c"
 /*
#include "pvg810\pvg810_api.c"
#include "pvg810\pserial.c"
#include "pvg810\uartCom.c"
#include "pvg810\comLayer.c"
#include "pvg810\networkProtocol.c"
#include "pvg810\PVG810_ProtocolMsg.c"
*/

//#include "pvg810\pvg810_api.c"
#include "pvg810\PVG810_HwLayerEmbedded.c"
...
if(!hot_restart)
  {
  init_pvg810_structs();
  init_pvg810_structs_appl();
 // CalTableFlashRead(0, CALTABLE_FLASH_ADDR, CALTABLE_LEN, (BYTE *)CALTABLE_RAM_ADDR);
  CalTableFlashRead(0, CALTABLE_FLASH_ADDR , PVG810_DATABASE_STRUCT_LEN,  (unsigned char*)gPvg810Database);

  PVG810_PROTOCOL_MSG_HostMsgTaskInit(0);
  APP_BBMode15GHzSet();
  }
...
if(variant != variant1) return; // 160319
