...
//#define PROG_KAZAH_16			// 155052 //try  kazah_16.cpp + filters act155051 1+0 use PVG710 maked mode 1+1 + pvg610_api.c	hostdriverforpc.cpp   utils.c endian.c
...
//#define	PROG_STM2UDP  //stm2udp.cpp
#define PROG_BCM	// 155052 //try  kazah_16.cpp + filters act155051 1+0 use PVG710 maked mode 1+1 + pvg610_api.c	hostdriverforpc.cpp   utils.c endian.c
...
#define SOFT_VER_STRING      "      19.02.04.1-1226    "//263 : maked init counter and data for write_buffer_char1()
#else
//#define SOFT_VER_STRING "Radian Ver. 01.00        "//263 : maked init counter and data for write_buffer_char1()
#ifndef PROG_STM2UDP
#ifdef	PROG_VNV1
#define SOFT_VER_STRING      "      18.03.30.2-1224    "//263 : maked init counter and data for write_buffer_char1()
#else
...
extern "C" void IOSpiSendR(6   , 3,  0,PD(char *IPBuff, unsigned long len);
...
extern "C" void IOSpiSendR(6   , 3,  0,BACO(char *IPBuff, unsigned long len);
...
extern "C" void InitSTM2UDP(void);

#define STM_DEV_MODE			(4)
#define STM1_MODE			(0x20)
#define STM1_CON			(0x22)
#define STM4_MODE			(0x30)
#define STM4_CON			(0x32)


#define PORT_XIL_ADDRD 		(0x40 + 0x26)
#define PORT_XIL_ADDRS 		(0x40 + 0x24)
#define IP_XIL_ADDRD 		(0x40 + 0x20)
#define IP_XIL_ADDRS 		(0x40 + 0x1C)
#define MAC_XIL_ADDR 		(0x50)
#define CHNL_OFFSET	     	(0x200)
#define SETS_OFFSET 		(0x40)
...
extern "C" void  ParseCommand1(void);
extern "C" void  ParseCommandA0(char *);
extern "C" void  ParseCommandA1(char *);
extern "C" void  ParseCommandA2(char *);
extern "C" void  ParseCommandA3(char *);
extern "C" void  ParseCommandA4(char *);
extern "C" void  ParseCommandA5(char *);
extern "C" void  ParseCommandA6(char *);
extern "C" void  ParseCommandA7(char *);
...
extern "C" void SetACMMask(unsigned char , unsigned char , unsigned char);
...
#define MAX_SIZE_TEXT_FILE (1980)
...
extern "C" void ModemAcmProfileMaskGet(unsigned char, unsigned char);
extern "C" unsigned long GetProvData(unsigned long);
extern "C" void DevAcmConfigurationGet(unsigned char,unsigned char );
...
extern "C" void ModemAcmProfileEnable(unsigned char , unsigned char , unsigned short);
extern "C" void ModemAcmSwitch(unsigned char, unsigned char, unsigned char);
extern "C" void ModemAcmThresholdSet(unsigned char, unsigned char, unsigned char, unsigned char, unsigned short, unsigned char,  unsigned char,  unsigned char, unsigned char);
...
//#define BMDN_CONNECT_USART   //if commented used spi
#define FIRMWARE_SIZE		(477916)
#define DC_SIZE				(23200+100)
#define CONFIG_SIZE			(38959)
#define ETH_FIRMWARE_SIZE	(30584)

#define FILE_SIZE    (70000)   //new configfile

#define XilFileDataAddressD_BCM	      (0xC0100060) // (XilDataAddressD3)   //  (0xC0100000)
#define XilFileDataAddressD_BCM1      (0xC0192060) //fw addr + 600k	size


//#define DC_SIZE						  (25000)

#define USE_USART2
//#ifdef USE_USART2
#define RBUFU2_SIZE (500)
extern char RBUFU2[RBUFU2_SIZE];
extern int  RBufu2pos;
extern "C" unsigned char HcStatisticsGet(void);
extern "C" unsigned char SetHeaderCompression(void);
extern "C" unsigned char SetLoopRxTx(unsigned char, unsigned char, unsigned char);
extern "C" unsigned char TxRxStatusGet(unsigned char scIndex); 
extern "C" unsigned char ADC_mode(unsigned char ,unsigned char); 
extern "C" unsigned char Chan_Adc(unsigned char ,unsigned char ); 
extern "C" void AGC_load(unsigned char, char *);
//extern "C" void AGC_load1(unsigned char);
extern "C" unsigned char EthPortClkSet(unsigned char);
extern "C" unsigned char  EthPortConfigure(unsigned char);
extern "C" void embRS232S_rcvbuf_Add(unsigned char);
extern "C" void Transmit2c(unsigned char);
extern "C" void bcm_usart2_rbuff_add(unsigned char);
extern "C" void bcm_transmit_usart2(char *, int);
extern "C" void bcm_transmit_usart2L(char *, int);
extern "C" unsigned char DeviceConfigure(void);
extern "C" unsigned char DeviceConfStart(void);
extern "C" unsigned char ParameterModify(char *, signed long);
extern "C" unsigned int SpiWriteCS2B(unsigned long,unsigned long, unsigned long);
extern "C" void SetFlashCs0(void);
extern "C" void InitSpiCS2B(void);
extern unsigned char flag_read;
extern unsigned long kdelay;
extern "C" unsigned char DeviceConfigurationResultGet();
...
//#define CONFIG_FILE_40  //110609 will maked later
#define CONFIG_FILE_80  //110609 will maked later
//#define EMPTY_LOOP //test!!!
...
extern "C" void ModemAcmCountersGet(unsigned char);
extern "C" void ModemAcmEngineEnable(unsigned char, unsigned char, unsigned char);
extern "C" void ModemAcmProfileEnable(unsigned char , nsigned char , unsigned short);
extern "C" void ModemAcmSwitch(unsigned char, unsigned char, unsigned char);
extern "C" void ModemAcmThresholdSet(unsigned char, (unsigned char, unsigned char, unsigned char, unsigned short, unsigned char,  unsigned char,  unsigned char, unsigned char);
//#define XILINX_SIZE      			(0x02000000) /*addresses  32Mb x 8 */
...
#ifdef CONFIG_FILE_80
#ifndef BIG_CFG_FILE
#define FILE_SIZE    (80000)  
#else
#define FILE_SIZE    (130000)  
#endif
#define CONFIG_FILE_PROVINGENT_STEP (FILE_SIZE>>1)
#define CONFIG_FILE_VARIANTS_STEP (FILE_SIZE + 1000)
...
#endif
/*
#ifdef CONFIG_FILE_70
#define FILE_SIZE    (70000)
//#define CONFIG_FILE_PROVINGENT_STEP (FILE_SIZE + 1000)
#define CONFIG_FILE_VARIANTS_STEP (FILE_SIZE + 1000)
//#define SYNT_DATA_OFFSET (CONFIG_FILE_PROVINGENT_STEP << 1)
#else
*/
...
#define MAX_CFG_FILE_SIZE  (50000)
#define MIN_CFG_FILE_SIZE  (29000)
...
extern "C" void ConfigFileLoadm1(unsigned long, unsigned char);
...
#define DEV_ID_SIZE				   (816)  //STM2UDP 
