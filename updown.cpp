//file updown.cpp
  ...
  if(crcud == embMsg485_1.Body(31))
  {
			...
			{
			   printfp1("_");
			   printfpd1("%X", embMsg485_1.Body(i));
		...
		if(GetTestMode() == 0x50)
			{
				...
				for(i=0; i<embMsg485Request_1.Length()+5; i++) 
				{
					...
					{
			   			printfp1(".");
			   			printfpd1("%X",embMsg485Request_1.body[i]);
			 		}
...
////////////////////////////////////////////////
  ...
  if(crcud == embMsg485_2.Body(31))
  {
			...
			{
			   printfp1("_");
			   printfpd1("%X", embMsg485_2.Body(i));
    ...
    if(tBuffEmbMsg485Request_2.Used() && send_keeper2)
		...
		//	printfp("\n\r________t1");
			...
			if(GetTestMode() == 0x50)
			 {
			   printfp1(".");
			   printfpd1("%X",embMsg485Request_2.body[i]);
     		 }
