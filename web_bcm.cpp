...
//t  UsedExp.State.Reg2.bit.NamesConfigFiles = 1;
...
//printfp(Key);
   ...
   //     sprintf(NewKey, "%s", GetPar022());  // 	
      ...
      //  memcpy((Key+15), FirmFileData.Value, 24);               // channel 7 (P6.7)
       ...
       {
   //     sprintf(NewKey, "%s", GetPar022());  // 	
//t        memcpy((Key+15), IFmoduleHeader.Value, 24);               // channel 7 (P6.7)
       }
...
//t		 memcpy((Key+15), FirmFileData.Value, 24);  
       }
...
//t 		    sprintf(NewKey, "%7d", (unsigned)MEthSend.Value);
        // 
      //      memcpy((Key+15), NewKey, 4);       
 	 ...
 	 //	sprintf(NewKey, "%2d", (unsigned)ClockReadDate()); 
		 //	  MEthModeI.MakeResultStrV();
//t 		    sprintf(NewKey, "%7d", (unsigned)MEthReceived.Value);
        // 
      //      memcpy((Key+15), NewKey, 4);       
        memcpy((Key+15), NewKey, 7);                
       }
 	 ...
 	 //	sprintf(NewKey, "%2d", (unsigned)ClockReadDate()); 
		 //	  MEthModeI.MakeResultStrV();
//t 		 sprintf(NewKey, "%7d", (unsigned)MEthSendU.Value);
        // 
      //      memcpy((Key+15), NewKey, 4);       
        memcpy((Key+15), NewKey, 7);                
       }
 	 ...
 	 //	sprintf(NewKey, "%2d", (unsigned)ClockReadDate()); 
	 //	  MEthModeI.MakeResultStrV();
//t 	    sprintf(NewKey, "%7d", (unsigned)MEthReceivedCRC.Value);
      // 
      //      memcpy((Key+15), NewKey, 4);       
        memcpy((Key+15), NewKey, 7);                
       }
...
//t		      sprintf(NewKey, "%02d", SaveVariants.Value + 1);
...
if (*(Key + 5) == '2')  //loadnumber
       {
//t LoadVariants.MakeResultStrV();
//Par014 =  SatTF.Value;
//return SatTF.pResultStr;
	  //    sprintf(NewKey, "%s", LoadVariants.pResultStr);  //
 //t	  	     sprintf(NewKey, "%02d", LoadVariants.Value + 1);
   /*
printfp("\n\r>>");
printfp(NewKey);
...
if (*(Key + 5) == '4')  //name
 ...
 //t	 	sprintf(NewKey, "%3d", (unsigned)ConfigFile.Value); 
