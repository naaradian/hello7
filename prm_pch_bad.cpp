...
{
 #ifndef PROG_PRM_PCH_S
 switch(inportb(POWER_PORT(POWER_PORT{
...
extern "C" void MakeNextStepScan5()
{
 ...
 {
   emb5CommandRecievmmandReciev.emb5commandrecieversetfrequ.frequ += emb5ScanFreq5.emb5scanfreq.step;
   emb5StatusReciever5.emb5statusreciever.frequ =  emb5CommandRecieverSetFrequ5.emb5commandrecieversetfrequ.frequ;
   curval5++;
 }
 else
...
#ifdef PROG_PRM_PCH_L_61
  case 28: break;//	u break;//	ur.emb2TypeVer.signature_software[5] =  embMsgUD_6.Body(1);	break;
...
case 2:	    emb5CommandRecieverSetAtt2.emb5commandrecieversetatt.stepAtt =  val;
   	 //		emb5StatusReciever2.emb5statusreciever.stepAtt =  emb5CommandRecieverSetAtt2.emb5commandrecievemandrecievepAtt;   
 	   		break;
